#******************************************************************************
#  Qt6Laz Bridge — derived from Qt6Pas by Jan Van hijfte, Željan Rikalo
#  Copyright (c) 2005-2024 by Jan Van hijfte, Željan Rikalo
#  Qt6Laz modifications Copyright (c) 2026 Qt6Laz contributors
#
#  See the included file COPYING.TXT for details about the copyright.
#  Licensed under LGPL-2.1.
#
#  This is a fork of the Qt6Pas C++ bridge from Lazarus, renamed to Qt6Laz
#  and extended with QLCLAbstractItemModel for Pascal-implemented custom models.
#******************************************************************************

# Binding Release Version — tracks upstream Qt6Pas version + our patch level
win32:VERSION = 6.2.10.1
else:VERSION = 6.2.10.1
VER_MAJ = 6
VER_MIN = 2
VER_PAT = 10
...
!equals(QT_MAJOR_VERSION,6)|!equals(QT_MINOR_VERSION,2) {
  message("Note: This binding version was generated for Qt 6.2.0. Current Qt is" $$QT_VERSION)
  message("Qt documents binary compatibility in each Version Change Note: https://doc.qt.io")
}

# Available Qt6 Pascal Binding Platforms: see http://wiki.freepascal.org/Qt6_binding#Supported_Platforms  
